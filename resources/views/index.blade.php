...
<section class="relative bg-white border-y border-slate-200">
    <div class="container-wide section">
        <div class="flex items-end justify-between mb-10">
            <div>
                <div class="text-sm font-medium text-brand-700 mb-2">Sélection éditoriale</div>
                <h2 class="font-heading text-3xl sm:text-4xl font-extrabold text-ink">Livres recommandés</h2>
            </div>
            <a href="{{ route('books.index') }}" class="hidden sm:inline-flex items-center gap-1 text-brand-700 hover:text-brand-900 font-medium text-sm">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
            ...
            {{-- Book 1: Physique Quantique --}}
            <article class="card-hover group cursor-pointer">
                <div class="aspect-[3/4] bg-blue-700 relative flex flex-col items-center justify-center text-white p-5">
                    <span class="font-heading text-5xl sm:text-6xl font-extrabold leading-none">PQ</span>
                    <span class="absolute bottom-4 text-[10px] uppercase tracking-[0.2em] text-blue-200 font-medium">Physique</span>
                    <div class="absolute bottom-0 left-0 right-0 h-1 bg-accent-500"></div>
                </div>
                <div class="card-body">
                    <h3 class="font-heading font-bold text-ink mb-1 group-hover:text-brand-800 transition-colors truncate">Physique Quantique</h3>
                    <div class="flex items-center justify-between mt-2">
                        <p class="text-xs text-ink-muted">Sciences exactes</p>
                        <span class="badge-success">Dispo</span>
                    </div>
                </div>
            </article>

            {{-- Book 2: Physique Organique --}}
            <article class="card-hover group cursor-pointer">
                <div class="aspect-[3/4] bg-emerald-700 relative flex flex-col items-center justify-center text-white p-5">
                    <span class="font-heading text-5xl sm:text-6xl font-extrabold leading-none">PO</span>
                    <span class="absolute bottom-4 text-[10px] uppercase tracking-[0.2em] text-emerald-200 font-medium">Physique</span>
                    <div class="absolute bottom-0 left-0 right-0 h-1 bg-accent-500"></div>
                </div>
                <div class="card-body">
                    <h3 class="font-heading font-bold text-ink mb-1 group-hover:text-brand-800 transition-colors truncate">Physique Organique</h3>
                    <div class="flex items-center justify-between mt-2">
                        <p class="text-xs text-ink-muted">Sciences exactes</p>
                        <span class="badge-success">Dispo</span>
                    </div>
            ...
            {{-- Book 3: Astrophysique --}}
            <article class="card-hover group cursor-pointer">
                <div class="aspect-[3/4] bg-purple-700 relative flex flex-col items-center justify-center text-white p-5">
                    <span class="font-heading text-5xl sm:text-6xl font-extrabold leading-none">A</span>
                    <span class="absolute bottom-4 text-[10px] uppercase tracking-[0.2em] text-purple-200 font-medium">Astronomie</span>
                    <div class="absolute bottom-0 left-0 right-0 h-1 bg-accent-500"></div>
                </div>
                <div class="card-body">
                    <h3 class="font-heading font-bold text-ink mb-1 group-hover:text-brand-800 transition-colors truncate">Astrophysique</h3>
                    <div class="flex items-center justify-between mt-2">
                        <p class="text-xs text-ink-muted">Sciences</p>
                        <span class="badge-success">Dispo</span>
                    </div>
                </div>
            </article>

            {{-- Book 4: Chimie Organique --}}
            <article class="card-hover group cursor-pointer">
                <div class="aspect-[3/4] bg-amber-700 relative flex flex-col items-center justify-center text-white p-5">
                    <span class="font-heading text-5xl sm:text-6xl font-extrabold leading-none">CO</span>
                    <span class="absolute bottom-4 text-[10px] uppercase tracking-[0.2em] text-amber-200 font-medium">Chimie</span>
                    <div class="absolute bottom-0 left-0 right-0 h-1 bg-accent-500"></div>
                </div>
                <div class="card-body">
                    <h3 class="font-heading font-bold text-ink mb-1 group-hover:text-brand-800 transition-colors truncate">Chimie Organique</h3>
                    <div class="flex items-center justify-between mt-2">
                        <p class="text-xs text-ink-muted">Chimie</p>
                        <span class="badge-success">Dispo</span>
                    </div>
                </div>
            </article>
            ...
            {{-- Book 5: Biologie --}}
            <article class="card-hover group cursor-pointer">
                <div class="aspect-[3/4] bg-rose-700 relative flex flex-col items-center justify-center text-white p-5">
                    <span class="font-heading text-5xl sm:text-6xl font-extrabold leading-none">B</span>
                    <span class="absolute bottom-4 text-[10px] uppercase tracking-[0.2em] text-rose-200 font-medium">Sciences</span>
                    <div class="absolute bottom-0 left-0 right-0 h-1 bg-accent-500"></div>
                </div>
                <div class="card-body">
                    <h3 class="font-heading font-bold text-ink mb-1 group-hover:text-brand-800 transition-colors truncate">Biologie</h3>
                    <div class="flex items-center justify-between mt-2">
                        <p class="text-xs text-ink-muted">Sciences naturelles</p>
                        <span class="badge-success">Dispo</span>
                    </div>
                </div>
            </article>
        ...
        <div class="text-center mt-8 sm:hidden">
            <a href="{{ route('books.index') }}" class="btn-secondary">Voir tout le catalogue</a>
        </div>
    </div>
</section>
